...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(144115188075855872); //2^57
...
const uint64_t MINIMUM_FEE                                   = 25000;
...
const char     CRYPTONOTE_NAME[]                             = "tanamcoin";
...
const int      P2P_DEFAULT_PORT                              = 1009;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 1012;
